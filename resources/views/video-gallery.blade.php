        ...
        <div class="filtr-container">
          <div class="col-12 col-sm-6 col-lg-6 col-xl-4 filtr-item" data-category="1, 3">
            <div class="pGallery-wrapper">
               <div class="pGallery-img"> <a class="product-video" href="https://www.youtube.com/watch?v=QcFTKM0NKL0" title="ThemeForest Project"><i class="fa fa-play-circle-o" aria-hidden="true"></i><img src="assets/images/video-poster1.jpg" alt=""/></a></div>
          ...
          <div class="col-12 col-sm-6 col-lg-6 col-xl-4 filtr-item" data-category="2, 1">
            <div class="pGallery-wrapper">
               <div class="pGallery-img"> <a class="product-video" href="https://www.youtube.com/watch?v=l7lWQSnjnsA" title="ThemeForest Project"><i class="fa fa-play-circle-o" aria-hidden="true"></i><img src="assets/images/video-poster2.jpg" alt=""/></a></div>
              <div class="freight-caption">
                <div class="label-text">
          ...
          <div class="col-12 col-sm-6 col-lg-6 col-xl-4 filtr-item" data-category="3, 2">
            <div class="pGallery-wrapper">
              <div class="pGallery-img"> <a class="product-video" href="https://www.youtube.com/watch?v=C0yWoHnpE2Q" title="ThemeForest Project"><i class="fa fa-play-circle-o" aria-hidden="true"></i><img src="assets/images/video-poster3.jpg" alt=""/></a></div>
              <div class="freight-caption">
                <div class="label-text">
          ...
          <div class="col-12 col-sm-6 col-lg-6 col-xl-4 filtr-item" data-category="1">
            <div class="pGallery-wrapper">
              <div class="pGallery-img"> <a class="product-video" href="https://www.youtube.com/watch?v=wFrvEQRASiA" title="ThemeForest Project"><i class="fa fa-play-circle-o" aria-hidden="true"></i><img src="assets/images/video-poster4.jpg" alt=""/></a></div>
              <div class="freight-caption">
                <div class="label-text">
