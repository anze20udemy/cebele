  ...
  <div class="homepage-slides-wrapper">
    <div class="homepage-slides"> 
      ...
      <div class="single-slide-item">
        <div class="slide-bg-holder slide-bg-4"></div>
        <div class="slider-caption caption-bg">
          <h2>The Best Quality Beekeeping Products</h2>
          <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
          <a href="#">Order now <i class="fa fa-angle-right"></i></a> </div>
      </div>
      <!-- Slider item1 end--> 
      
      <!-- Slider item2 start-->
      <div class="single-slide-item">
        <div class="slide-bg-holder slide-bg-1"></div>
        <div class="slider-caption caption-bg">
          <h2>Qualityful honey to be always on demand</h2>
          <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
          <a href="#">Contact with us <i class="fa fa-angle-right"></i></a> </div>
      </div>
      <!-- Slider item2 end--> 
      
      <!-- Slider item2 start-->
      <div class="single-slide-item">
        <div class="slide-bg-holder slide-bg-3"></div>
        <div class="slider-caption caption-bg">
          <h2>How to start beekeeping</h2>
          <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
          <a href="#">Contact with us <i class="fa fa-angle-right"></i></a> </div>
      </div>
      <!-- Slider item2 end--> 
  ...
  <div class="bee-content-block home-blog pt0 pb60">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="section-title">
            <h2 class="title-bg">Latest Blog Post</h2>
          </div>
        </div>
      </div>
      <div class="row">
