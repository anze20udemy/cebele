...
Route::view('/didyouknow', 'didyouknow');
...
//Route::view('/product-2', 'product-2');
...
Route::view('/photo-gallery', 'photo-gallery');

Route::view('/login', 'login');
Route::view('/change-pass', 'change-pass');
Route::view('/order-form', 'order-form');
Route::view('/order-tracking', 'order-tracking');

Route::view('/my-wishlist', 'my-wishlist');
//Route::view('/my-order', 'my-order');
Route::view('/edit-account', 'edit-account');
